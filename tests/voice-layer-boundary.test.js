...
const v1 = readFileSync(new URL("../core/voice/voice-v1-capture-controller.js", import.meta.url), "utf8");
const v2 = readFileSync(new URL("../core/voice/voice-lifecycle-coordinator.js", import.meta.url), "utf8");
const v3Logic = readFileSync(new URL("../core/voice/voice-v3-interaction.js", import.meta.url), "utf8");
